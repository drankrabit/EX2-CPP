...
int main()
{
    ...
    cout<<g4;           // Should print the multiplication of the matrices of g1 and g2: [1, 0, 2], [1, 3, 1], [1, 0, 2] (before that it was said it should print out [0, 0, 2], [1, 0, 1], [1, 0, 0] but if you calculate the answer yourself you will see that that is incorrect)
